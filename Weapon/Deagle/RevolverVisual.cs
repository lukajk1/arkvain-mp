...
/// </summary>
public class RevolverVisual : WeaponVisual<RevolverLogic>
{
    ...
    /// <summary>
    /// Called when the deagle shoots. Plays muzzle flash and shoot sound (every other shot).
    /// </summary>
    ...
    /// <summary>
    /// Called when the deagle becomes the active weapon. Shows the viewmodel.
    /// </summary>
    ...
    /// <summary>
    /// Called when the deagle is holstered (deactivated).
    /// </summary>
